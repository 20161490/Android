package com.example.safefamily.chat;
...
import com.example.safefamily.model.NotificationModel;
...
public class MEssage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_m_essage);
        ...
        recyclerView = (RecyclerView) findViewById(R.id.message_reclerview);
    ...
    void sendGcm(){
        ...
        Request request = new Request.Builder()
                ...
                .addHeader("Authorization","key=AAAARTEsbyw:APA91bEk6meCj43ew6_21zepFDydfMu0J7CVKudG8lnT09nQpCwj8vjb91LwcEO8v1niCdM19pKfW-y124Vd1oFdADf9ayDLVqMRMJBOazybGoUyBR3X22rLJsiclYGos-htspP5ocdM")
    ...
    class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public RecyclerViewAdapter() {
            ...
            FirebaseDatabase.getInstance().getReference().child("users").child("가족지킴이 어플").child(destinatonUid).addListenerForSingleValueEvent(new ValueEventListener() {
                @Override
        ...
        public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
            ...
            if(comments.get(position).uid.equals(uid)){
                ...
                messageViewHolder.linearLayout_destination.setVisibility(View.INVISIBLE);//내가보낸 메세지를 띄울필요없음
