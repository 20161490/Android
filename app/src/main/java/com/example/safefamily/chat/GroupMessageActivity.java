...
public class GroupMessageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editText = (EditText)findViewById(R.id.gropMessageActivity_editText);
        FirebaseDatabase.getInstance().getReference().child("users").child("가족지킴이 어플").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
...
//                users = (Map<String, Usermodel>) snapshot.getValue();
                init();
                recyclerView =(RecyclerView) findViewById(R.id.gropMessageActivity_recyclerview);
...
//        recyclerView.setLayoutManager(new LinearLayoutManager(this));
    ...
    void init(){
        Button button = (Button) findViewById(R.id.gropMessageActivity_button);
